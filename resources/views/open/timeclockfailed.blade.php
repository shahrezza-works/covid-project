...
<body>
    ...
    <div class="container-fluid mt-4">
        <center>
            ...
            <h5>Sila cuba semula untuk Clock Out. Terima Kasih. <br><i>Please try again to Clock Out. Thank You.</i></h5>

            <a href="/form/staff/clockout" class="btn btn-primary"><i class="fas fa-arrow-left">&nbsp; BACK</i></a>
        </center>
