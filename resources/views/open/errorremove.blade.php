...
<body>
    ...
    <div class="container-fluid mt-4">
        <center>
            <h3 class="mb-4">Tidak berjaya untuk mendaftar. <br><i>Failed to register.</i></h3>

            <h5>Kod QR ini telah dipadam. Sila cuba kod QR yang lain. Terima Kasih 
                <br><i>This QR Code has been removed. Please try others QR Code. Thank You.</i></h5>
        </center>
