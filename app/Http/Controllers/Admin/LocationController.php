...
class LocationController extends Controller
{
    ...
    public function getdata($location_id, Request $request)
    {
        ...
        if($borang_type == 3){
            ...
            ->select('respon_staff.id', 'respon_staff.nama', 'respon_staff.no_pekerja', 'respon_staff.clockin', 'respon_staff.clockout', 'respon_staff.jabatan', 'respon_staff.suhu', DB::raw('DATE(respon_staff.created_at) as created_at, TIME(respon_staff.created_at) as time_at'), 'location.nama_premis', 'location.nama_bangunan', 'location.kawasan', 'location.poskod', 'location.negeri')
